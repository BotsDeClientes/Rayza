...
> 🕹️ *VS/FICHA - FREE FIRE* 🕹️

💖︎ _${usedPrefix}Sur4_
💖︎ _${usedPrefix}Sur6_
💖︎ _${usedPrefix}InternaSur4_
💖︎ _${usedPrefix}Internasur6_
💖︎ _${usedPrefix}Formulario_
💖︎ _${usedPrefix}Norte4_
💖︎ _${usedPrefix}Norte6_
💖︎ _${usedPrefix}InternaNorte4_
💖︎ _${usedPrefix}InternaNorte6_
💖︎ _${usedPrefix}Formulario_

> 🧾 *AJUSTES/INFO - GRUPO* 🧾

💖︎ _${usedPrefix}configuracion_
💖︎ _${usedPrefix}settings_
💖︎ _${usedPrefix}vergrupo_

> 🪄 *DESCARGAS* 🪄

💖︎ _${usedPrefix}imagen | image *texto*_
💖︎ _${usedPrefix}pinterest | dlpinterest *texto*_
💖︎ _${usedPrefix}wallpaper|wp *texto*_
💖︎ _${usedPrefix}play | play2 *texto o link*_
💖︎ _${usedPrefix}play.1 *texto o link*_
💖︎ _${usedPrefix}play.2 *texto o link*_ 
💖︎ _${usedPrefix}ytmp3 | yta *link*_
💖︎ _${usedPrefix}ytmp4 | ytv *link*_
💖︎ _${usedPrefix}pdocaudio | ytadoc *link*_
💖︎ _${usedPrefix}pdocvieo | ytvdoc *link*_
💖︎ _${usedPrefix}tw |twdl | twitter *link*_
💖︎ _${usedPrefix}facebook | fb *link*_
💖︎ _${usedPrefix}instagram *link video o imagen*_
💖︎ _${usedPrefix}verig | igstalk *usuario(a)*_
💖︎ _${usedPrefix}ighistoria | igstory *usuario(a)*_
💖︎ _${usedPrefix}tiktok *link*_
💖︎ _${usedPrefix}tiktokimagen | ttimagen *link*_
💖︎ _${usedPrefix}tiktokfoto | tiktokphoto *usuario(a)*_
💖︎ _${usedPrefix}vertiktok | tiktokstalk *usuario(a)*_
💖︎ _${usedPrefix}mediafire | dlmediafire *link*_
💖︎ _${usedPrefix}clonarepo | gitclone *link*_
💖︎ _${usedPrefix}clima *país ciudad*_
💖︎ _${usedPrefix}consejo_
💖︎ _${usedPrefix}morse codificar *texto*_
💖︎ _${usedPrefix}morse decodificar *morse*_
💖︎ _${usedPrefix}fraseromantica_
💖︎ _${usedPrefix}historia_
💖︎ _${usedPrefix}drive | dldrive *link*_
> 👤 *CHAT ANONIMO* 👤

💖︎ _${usedPrefix}chatanonimo | anonimochat_
💖︎ _${usedPrefix}anonimoch_
...
💖︎ _${usedPrefix}add *numero*_
💖︎ _${usedPrefix}mute | unmute *@tag*_
💖︎ _${usedPrefix}sacar | ban | kick  *@tag*_
💖︎ _${usedPrefix}grupo *abrir o cerrar*_
💖︎ _${usedPrefix}group *open o close*_
💖︎ _${usedPrefix}daradmin | promote *@tag*_
💖︎ _${usedPrefix}quitar | demote *@tag*_
💖︎ _${usedPrefix}banchat_
💖︎ _${usedPrefix}unbanchat_
💖︎ _${usedPrefix}banuser *@tag*_
💖︎ _${usedPrefix}unbanuser *@tag*_
💖︎ _${usedPrefix}admins *texto*_
💖︎ _${usedPrefix}invocar *texto*_
💖︎ _${usedPrefix}tagall *texto*_
💖︎ _${usedPrefix}hidetag *texto*_
💖︎ _${usedPrefix}infogrupo | infogroup_
💖︎ _${usedPrefix}grupotiempo | grouptime *Cantidad*_
💖︎ _${usedPrefix}advertencia *@tag*_
💖︎ _${usedPrefix}deladvertencia *@tag*_
💖︎ _${usedPrefix}delwarn *@tag*_
💖︎ _${usedPrefix}crearvoto | startvoto *texto*_
💖︎ _${usedPrefix}sivotar | upvote_
💖︎ _${usedPrefix}novotar | devote_
💖︎ _${usedPrefix}vervotos | cekvoto_
💖︎ _${usedPrefix}delvoto | deletevoto_
💖︎ _${usedPrefix}enlace | link_
💖︎ _${usedPrefix}newnombre | nuevonombre *texto*_
💖︎ _${usedPrefix}newdesc | descripcion *texto*_
💖︎ _${usedPrefix}setwelcome | bienvenida *texto*_
💖︎ _${usedPrefix}setbye | despedida *texto*_
💖︎ _${usedPrefix}nuevoenlace | resetlink_
💖︎ _${usedPrefix}on_
💖︎ _${usedPrefix}off_

> 💞 *PAREJAS* 💞

💖︎ _${usedPrefix}listaparejas | listship_
💖︎ _${usedPrefix}mipareja | mylove_
💖︎ _${usedPrefix}pareja | couple *@tag*_
💖︎ _${usedPrefix}aceptar | accept *@tag*_
💖︎ _${usedPrefix}rechazar | decline *@tag*_
💖︎ _${usedPrefix}terminar | finish *@tag*_
...
💖︎ _${usedPrefix}hornymenu_

> 🔁 *CONVERTIDORES* 🔁

💖︎ _${usedPrefix}toimg | img | jpg *sticker*_
💖︎ _${usedPrefix}toanime | jadianime *foto*_
💖︎ _${usedPrefix}tomp3 | mp3 *video o nota de voz*_
💖︎ _${usedPrefix}tovn | vn *video o audio*_
💖︎ _${usedPrefix}tovideo *audio*_
💖︎ _${usedPrefix}tourl *video, imagen*_
💖︎ _${usedPrefix}toenlace  *video, imagen o audio*_
💖︎ _${usedPrefix}tts es *texto*_

> 🔆 *LOGOS* 🔆

💖︎ _${usedPrefix}logos *efecto texto*_
💖︎ _${usedPrefix}menulogos2_

> 💥 *EFECTOS* 💥

💖︎ _${usedPrefix}simpcard *@tag*_
💖︎ _${usedPrefix}hornycard *@tag*_
💖︎ _${usedPrefix}lolice *@tag*_
💖︎ _${usedPrefix}ytcomment *texto*_
💖︎ _${usedPrefix}itssostupid_
💖︎ _${usedPrefix}pixelar_
💖︎ _${usedPrefix}blur_

> 🍭 *RANDOM/ANIME* 🍭

💖︎ _${usedPrefix}chica_
💖︎ _${usedPrefix}chico_
💖︎ _${usedPrefix}cristianoronaldo_
💖︎ _${usedPrefix}messi_
💖︎ _${usedPrefix}meme_
💖︎ _${usedPrefix}meme2_
💖︎ _${usedPrefix}itzy_
💖︎ _${usedPrefix}blackpink_
💖︎ _${usedPrefix}kpop *blackpink, o exo, o bts*_
💖︎ _${usedPrefix}lolivid_
💖︎ _${usedPrefix}loli_
💖︎ _${usedPrefix}navidad_
💖︎ _${usedPrefix}ppcouple_
💖︎ _${usedPrefix}neko_
💖︎ _${usedPrefix}waifu_
💖︎ _${usedPrefix}akira_
💖︎ _${usedPrefix}akiyama_
💖︎ _${usedPrefix}anna_
💖︎ _${usedPrefix}asuna_
💖︎ _${usedPrefix}ayuzawa_
💖︎ _${usedPrefix}boruto_
💖︎ _${usedPrefix}chiho_
💖︎ _${usedPrefix}chitoge_
💖︎ _${usedPrefix}deidara_
💖︎ _${usedPrefix}erza_
💖︎ _${usedPrefix}elaina_
💖︎ _${usedPrefix}eba_
💖︎ _${usedPrefix}emilia_
💖︎ _${usedPrefix}hestia_
💖︎ _${usedPrefix}hinata_
💖︎ _${usedPrefix}inori_
💖︎ _${usedPrefix}isuzu_
💖︎ _${usedPrefix}itachi_
💖︎ _${usedPrefix}itori_
💖︎ _${usedPrefix}kaga_
💖︎ _${usedPrefix}kagura_
💖︎ _${usedPrefix}kaori_
💖︎ _${usedPrefix}keneki_
💖︎ _${usedPrefix}kotori_
💖︎ _${usedPrefix}kurumi_
💖︎ _${usedPrefix}madara_
💖︎ _${usedPrefix}mikasa_
💖︎ _${usedPrefix}miku_
💖︎ _${usedPrefix}minato_
💖︎ _${usedPrefix}naruto_
💖︎ _${usedPrefix}nezuko_
💖︎ _${usedPrefix}sagiri_
💖︎ _${usedPrefix}sasuke_
💖︎ _${usedPrefix}sakura_
💖︎ _${usedPrefix}cosplay_
...
💖︎ _${usedPrefix}mangainfo *texto*_
💖︎ _${usedPrefix}google *texto*_
💖︎ _${usedPrefix}googlelyrics *texto*_
💖︎ _${usedPrefix}letra | lirik *texto*_
💖︎ _${usedPrefix}ytsearch | yts *texto*_
💖︎ _${usedPrefix}wiki | wikipedia *texto*_

> 🛠️ *HERRAMIENTAS* 🛠️

💖︎ _${usedPrefix}afk *motivo*_
💖︎ _${usedPrefix}acortar *url*_
💖︎ _${usedPrefix}calc *operacion math*_
💖︎ _${usedPrefix}del *respondre a mensaje del Bot*_
💖︎ _${usedPrefix}qrcode *texto*_
💖︎ _${usedPrefix}readmore *texto1|texto2*_
💖︎ _${usedPrefix}spamwa *numero|texto|cantidad*_
💖︎ _${usedPrefix}styletext *texto*_
💖︎ _${usedPrefix}traducir *texto*_
💖︎ _${usedPrefix}morse codificar *texto*_
💖︎ _${usedPrefix}morse decodificar *morse*_
💖︎ _${usedPrefix}encuesta | poll *Motivo*_
💖︎ _${usedPrefix}horario_

> ⚗️ *COMANDOS RPG* ⚗️

💖︎ _${usedPrefix}botemporal *enlace* *cantidad*_
💖︎ _${usedPrefix}addbot *enlace* *cantidad*_
💖︎ _${usedPrefix}pase premium_
💖︎ _${usedPrefix}pass premium_
💖︎ _${usedPrefix}listapremium | listprem_
💖︎ _${usedPrefix}transfer *tipo cantidad @tag*_
💖︎ _${usedPrefix}dar *tipo cantidad @tag*_
💖︎ _${usedPrefix}enviar *tipo cantidad @tag*_
💖︎ _${usedPrefix}balance_
💖︎ _${usedPrefix}cartera | wallet_
💖︎ _${usedPrefix}experiencia | exp_
💖︎ _${usedPrefix}top | lb | leaderboard_
💖︎ _${usedPrefix}nivel | level | lvl_
💖︎ _${usedPrefix}rol | rango_
💖︎ _${usedPrefix}inventario | inventory_
💖︎ _${usedPrefix}aventura | adventure_
💖︎ _${usedPrefix}caza | cazar | hunt_
💖︎ _${usedPrefix}pescar | fishing_
💖︎ _${usedPrefix}animales_
💖︎ _${usedPrefix}alimentos_
💖︎ _${usedPrefix}curar | heal_
💖︎ _${usedPrefix}buy_
💖︎ _${usedPrefix}sell_
💖︎ _${usedPrefix}verificar | registrar_
💖︎ _${usedPrefix}perfil | profile_
💖︎ _${usedPrefix}myns_
💖︎ _${usedPrefix}unreg *numero de serie*_
💖︎ _${usedPrefix}minardiamantes | minargemas_
💖︎ _${usedPrefix}minargatacoins | minarcoins_
💖︎ _${usedPrefix}minarexperiencia | minarexp_
💖︎ _${usedPrefix}minar *:* minar2 *:* minar3_
💖︎ _${usedPrefix}rob | robar 
💖︎ _${usedPrefix}crime
💖︎ _${usedPrefix}reclamar | regalo | claim_
💖︎ _${usedPrefix}cadahora | hourly_
💖︎ _${usedPrefix}cadasemana | semanal | weekly_
💖︎ _${usedPrefix}cadames | mes | monthly_
💖︎ _${usedPrefix}cofre | abrircofre | coffer_
💖︎ _${usedPrefix}trabajar | work_

> 🌟 *RPG Fnatasy* 🌟

💖︎ _${usedPrefix}fantasy | fy_
💖︎ _c_
💖︎ _${usedPrefix}fyguia | fyguide_
💖︎ _${usedPrefix}fantasyinfo | fyinfo_
💖︎ _${usedPrefix}fyagregar | fyadd_
💖︎ _${usedPrefix}fycambiar | fychange_
💖︎ _${usedPrefix}fylista | fyl_
💖︎ _${usedPrefix}fantasymy | fymy_
💖︎ _${usedPrefix}fyentregar | fytransfer_

> 🏆 *TOP en RPG Fnatasy* 🏆

💖︎ _${usedPrefix}fytendencia | fyranking_
...
💖︎ _${usedPrefix}sticker | s *imagen o video*_
💖︎ _${usedPrefix}sticker | s *url de tipo jpg*_
💖︎ _${usedPrefix}emojimix *😺+😆*_
💖︎ _${usedPrefix}scircle | círculo *imagen*_
💖︎ _${usedPrefix}semoji | emoji *tipo emoji*_
...
💖︎ _${usedPrefix}ttp6 *texto*_
💖︎ _${usedPrefix}dado_
💖︎ _${usedPrefix}stickermarker *efecto : responder a imagen*_
💖︎ _${usedPrefix}stickerfilter *efecto : responder a imagen*_
💖︎ _${usedPrefix}cs *:* cs2_

> 😼 *MODIFICAR STICKERS* 😼

💖︎ _${usedPrefix}wm *packname|author*_
💖︎ _${usedPrefix}wm *texto1|texto2*_

> 👻 *STICKERS DINÁMICOS* 👻

💖︎ _${usedPrefix}palmaditas | pat *@tag*_
💖︎ _${usedPrefix}bofetada | slap *@tag*_
💖︎ _${usedPrefix}golpear *@tag*_
💖︎ _${usedPrefix}besar | kiss *@tag*_
💖︎ _${usedPrefix}alimentar | food *@tag*_

> 💎 *PARA MI CREADOR/A* 💎

💖︎ _${usedPrefix}join *enlace*_
💖︎ _${usedPrefix}unete *enlace*_
💖︎ _${usedPrefix}dardiamantes *cantidad*_
💖︎ _${usedPrefix}darxp *cantidad*_
💖︎ _${usedPrefix}dargatacoins *cantidad*_
💖︎ _${usedPrefix}addprem | userpremium *@tag* *cantidad*_
💖︎ _${usedPrefix}addprem2 | userpremium2 *@tag* *cantidad*_
💖︎ _${usedPrefix}addprem3 | userpremium3 *@tag* *cantidad*_
💖︎ _${usedPrefix}addprem4 | userpremium4 *@tag* *cantidad*_
💖︎ _${usedPrefix}idioma | language_
💖︎ _${usedPrefix}cajafuerte_
💖︎ _${usedPrefix}comunicar | broadcastall | bc *texto*_
💖︎ _${usedPrefix}broadcastchats | bcc *texto*_
💖︎ _${usedPrefix}comunicarpv *texto*_
💖︎ _${usedPrefix}broadcastgc *texto*_
💖︎ _${usedPrefix}comunicargrupos *texto*_
💖︎ _${usedPrefix}borrartmp | cleartmp_
💖︎ _${usedPrefix}delexp *@tag*_
💖︎ _${usedPrefix}delcoins *@tag*_
💖︎ _${usedPrefix}deldiamantes *@tag*_
💖︎ _${usedPrefix}reiniciar | restart_
💖︎ _${usedPrefix}ctualizar | update_
💖︎ _${usedPrefix}addprem | +prem *@tag*_
💖︎ _${usedPrefix}delprem | -prem *@tag*_
💖︎ _${usedPrefix}listapremium | listprem_
💖︎ _${usedPrefix}añadirdiamantes *@tag cantidad*_
💖︎ _${usedPrefix}añadirxp *@tag cantidad*_
💖︎ _${usedPrefix}añadircoins *@tag cantidad*_
`.trim()
await conn.sendFile(m.chat, gataImg, 'lp.jpg', menu, m, fakeChannel, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝘔𝘪𝘥𝘢𝘳𝘪 𝘉𝘰𝘵 𝘗𝘳𝘰 / @𝘙𝘢𝘺𝘻𝘢.𝘚𝘵 💖︎︎', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu }}})
...
let message = ''
if (formattedCommand) {
message += `💖︎ \`${prefix}${formattedCommand}\``

...
try {
if (command == 'play.1') {
conn.reply(m.chat, lenguajeGB['smsAvisoEG']() + mid.smsAud, m, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: '𝘍𝘭𝘢𝘴𝘩 𝘉𝘰𝘵 / @𝘠𝘢𝘭𝘭𝘪𝘤𝘰.𝘖𝘸𝘯𝘦𝘳 ⚡︎', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}})
try {
...
if (command == 'play.2') {
conn.reply(m.chat, lenguajeGB['smsAvisoEG']() + mid.smsVid, m, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: '𝘍𝘭𝘢𝘴𝘩 𝘉𝘰𝘵 / @𝘠𝘢𝘭𝘭𝘪𝘤𝘰.𝘖𝘸𝘯𝘦𝘳 ⚡︎', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}) 
try {
